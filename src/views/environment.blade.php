@extends('vendor.installer.layouts.master') @section('template_title') Step 3 |
Environment Settings @endsection @section('title')
<i class="fa fa-cog fa-fw" aria-hidden="true"></i>
Environment Settings @endsection @section('container')
...
<div class="buttons">
    ...
    <a
        href="{{ route('LaravelInstaller::environmentClassic') }}"
        class="button button-classic"
    >
