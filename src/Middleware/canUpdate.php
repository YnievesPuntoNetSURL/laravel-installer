...
namespace YnievesPuntoNetSURL\LaravelInstaller\Middleware;

use Closure;
use YnievesPuntoNetSURL\LaravelInstaller\Middleware\canInstall;

class canUpdate
{
    use \YnievesPuntoNetSURL\LaravelInstaller\Helpers\MigrationsHelper;
