...
Route::group(['namespace' => 'YnievesPuntoNetSURL\LaravelInstaller\Controllers','middleware' => ['web', 'install']], function() {
Route::get('error/{var}', [
    'uses' => 'WelcomeController@error'
 ]);
});

Route::group(['prefix' => 'install','as' => 'LaravelInstaller::','namespace' => 'YnievesPuntoNetSURL\LaravelInstaller\Controllers','middleware' => ['web', 'install']], function() {
    Route::get('/', [
        'as' => 'welcome',
...
Route::group(['prefix' => 'update','as' => 'LaravelUpdater::','namespace' => 'YnievesPuntoNetSURL\LaravelInstaller\Controllers','middleware' => 'web'],function() {
